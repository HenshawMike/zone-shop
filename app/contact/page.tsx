  ...
  return (
    <div className="container mx-auto px-4 py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="bg-black p-12 border border-zinc-900">
          ...
          <form ref={formRef} action={formAction} className="space-y-12">
            <div className="space-y-4">
              ...
              <input
                ...
                name="name"
                type="text"
                className="w-full bg-transparent border-b border-zinc-800 p-2 text-sm focus:border-white focus:outline-none transition-colors"
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                name="message"
                rows={4}
                className="w-full bg-transparent border-b border-zinc-800 p-2 text-sm focus:border-white focus:outline-none transition-colors resize-none"
